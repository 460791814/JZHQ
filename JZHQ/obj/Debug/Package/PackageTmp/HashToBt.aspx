<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HashToBt.aspx.cs" Inherits="JZHQ.HashToBt" %>
...
<div class="mainbox">
        <div class="conbox pdlr20 cl">
            <div class="fl" style="width: 600px;">
                <div class="link">
                    <textarea name="magnet" id="hash" class="ta magta">请在此输入磁力链接...</textarea></div>
                <p>
                    <a class="create" id="ToBT" ><i >点此转换</i></a></p>
